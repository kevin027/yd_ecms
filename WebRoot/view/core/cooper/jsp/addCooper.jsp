...
<s:form id="saveCooperForm" method="post" 
	namespace="/cooper" action="saveCooper" cssStyle="padding-top:10px; padding-bottom:0px;">
	
	<!-- 隐藏域 -->
	<s:hidden name="cooper.id" id="saveId" />
...
<script src="<%=basePath %>core/cooper/js/addCooper.js" /></script>
