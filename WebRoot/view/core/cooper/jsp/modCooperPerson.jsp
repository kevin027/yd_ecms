...
<s:form id="saveCooperPersonForm" method="post" 
	namespace="/cooperPerson" action="updateCooperPerson" cssStyle="padding-top:10px; padding-bottom:0px;">
...
<script src="<%=basePath %>core/cooper/js/modCooperPerson.js" /></script>
