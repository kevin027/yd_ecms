package com.yida.basedata.checkcontent.entity;
...
public class CheckContent implements Serializable {
	...
	@Column(name="sort", columnDefinition="INT", nullable=false)
	private Integer sort;

	@Override
	public String toString() {
		return "CheckContent [name=" + name + "]";
	}
